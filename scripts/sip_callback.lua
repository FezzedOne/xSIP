...
function sip.callback.selectItem()
  ...
  -- Show text
  widget.setText(sip.widgets.itemName, (sip.item.parameters or {}).shortdescription or config.shortdescription or sip.item.name)
  widget.setText(sip.widgets.itemDescription, (sip.item.parameters or {}).description or config.description or sip.lines.descriptionMissing)
